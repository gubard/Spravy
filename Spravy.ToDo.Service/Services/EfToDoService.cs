                ...
                context => context.Set<ToDoItemEntity>()
                   ...
                   .IfSuccessAsync(
                        items =>
                        {
                            ...
                            {
                                selectorItems = roots.IfSuccessForEach(
                            ...
                            {
                                favoriteItems = dictionary.Where(x => x.Value.IsFavorite)
                                   .ToArray()
                                   .ToReadOnlyMemory()
                            ...
                            {
                                bookmarkItems = dictionary.Where(x => x.Value.IsBookmark)
