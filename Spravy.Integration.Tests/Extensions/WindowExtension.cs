...
public static class WindowExtension
{
    ...
    public static TWindow KeyHandleQwerty<TWindow>(this TWindow window, PhysicalKey key, RawInputModifiers modifiers)
    ...
    {
        return window.GetControl<ContentControl>("MainView")
           .GetContentView<MainView>()
           .GetControl<ContentControl>("MainSplit")
           .GetContentView<MainSplitView>();
    }

    public static ( DialogControl ErrorDialogHost, DialogControl ProgressDialogHost, DialogControl InputDialogHost,
        DialogControl ContentDialogHost, object Content ) GetMainControls(this Window window)
    {
        var mainView = window.GetMainView();

        return (mainView.GetControl<DialogControl>("ErrorDialogControl"),
    ...
    {
        var contentPresenter = window.GetMainSplitView()
