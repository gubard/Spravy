...
public static class WindowExtension
{
    public static Window AddToDoItem(this Window window, string name)
    {
        ...
        view.CheckLastToDoItemName("Loading...").RunJobsAll(2);
    ...
    public static ( DialogHost ErrorDialogHost, DialogHost ProgressDialogHost, DialogHost InputDialogHost, DialogHost
        ContentDialogHost, object Content ) GetMainControls(this Window window)
    {
        ...
        var content = contentDialogHost.Content
           .ThrowIfNull()
        ...
        where TView : UserControl where TViewModel : ViewModelBase
    {
        return window.GetErrorDialogHost()
           ...
           .Case(dh => dh.DialogContent.ThrowIfNull().Case(dc => dc.ThrowIfIsNotCast<TViewModel>()))
           .GetVisualChildren()
           .Single()
           .ThrowIfIsNotCast<Grid>()
           .Children
