                ...
                w => w.SetSize(1000, 1000)
                   ...
                   .Case(() => w
                       .Case(() => w.GetCurrentView<LoginView, LoginViewModel>()
                           ...
                           .ClickOn(w)
                           .RunJobsAll(1))
                       .Case(() => w.GetCurrentView<CreateUserView, CreateUserViewModel>()
                       ...
                       .Case(c => c.FindControl<TextBox>(ElementNames.EmailTextBox)
                           .ThrowIfNull()
                           .MustFocused()
                       ...
                       .Case(() => w.KeyHandleQwerty(PhysicalKey.Enter, RawInputModifiers.None))
                       .Case(c => c.FindControl<TextBox>(ElementNames.PasswordTextBox)
                           .ThrowIfNull()
                           .MustFocused()
                           .ValidateCreateUserViewTextBoxError(w, c, TextHelper.TextLength513)
