...
{
    public static partial AnnuallyPeriodicity ToAnnuallyPeriodicity(this AnnuallyPeriodicityGrpc value);
    public static partial AnnuallyPeriodicityGrpc ToAnnuallyPeriodicityGrpc(this AnnuallyPeriodicity value);
    public static partial MonthlyPeriodicity ToMonthlyPeriodicity(this MonthlyPeriodicityGrpc value);
    public static partial MonthlyPeriodicityGrpc ToMonthlyPeriodicityGrpc(this MonthlyPeriodicity value);
    public static partial ResetToDoItemOptions ToResetToDoItemOptions(this ResetToDoItemRequest value);
    public static partial ResetToDoItemRequest ToResetToDoItemRequest(this ResetToDoItemOptions value);
    public static partial WeeklyPeriodicity ToWeeklyPeriodicity(this WeeklyPeriodicityGrpc value);
    public static partial WeeklyPeriodicityGrpc ToWeeklyPeriodicityGrpc(this WeeklyPeriodicity value);
    public static partial MonthlyPeriodicity ToMonthlyPeriodicity(this GetMonthlyPeriodicityReply value);
    public static partial GetMonthlyPeriodicityReply ToGetMonthlyPeriodicityReply(this MonthlyPeriodicity value);
    ...
    public static partial ReadOnlyMemory<ToDoItemGrpc> ToToDoItemGrpc(this ReadOnlyMemory<ToDoItem> value);
    ...
    public static partial ValueToDoItemSettings ToValueToDoItemSettings(this GetValueToDoItemSettingsReply value);
    ...
    public static partial ReadOnlyMemory<ToDoShortItemGrpc> ToToDoShortItemGrpc(this ReadOnlyMemory<ToDoShortItem> value);
    public static partial ReadOnlyMemory<ToDoShortItem> ToToDoShortItem(this IEnumerable<ToDoShortItemGrpc> value);
    public static partial AddRootToDoItemRequest ToAddRootToDoItemRequest(this AddRootToDoItemOptions value);
    public static partial AddRootToDoItemOptions ToAddRootToDoItemOptions(this AddRootToDoItemRequest value);
    ...
    public static partial GetAnnuallyPeriodicityReply ToGetAnnuallyPeriodicityReply(this AnnuallyPeriodicity value);
    public static partial AnnuallyPeriodicity ToAnnuallyPeriodicity(this GetAnnuallyPeriodicityReply value);
    public static partial ToDoItemToStringRequest ToToDoItemToStringRequest(this ToDoItemToStringOptions value);
    public static partial ToDoItemToStringOptions ToToDoItemToStringOptions(this ToDoItemToStringRequest value);
    ...
    public static partial ReadOnlyMemory<ToDoSelectorItem> ToToDoSelectorItem(this IEnumerable<ToDoSelectorItemGrpc> value);
    public static partial GetWeeklyPeriodicityReply ToGetWeeklyPeriodicityReply(this WeeklyPeriodicity value);
    public static partial WeeklyPeriodicity ToWeeklyPeriodicity(this GetWeeklyPeriodicityReply value);
    public static partial PlannedToDoItemSettings ToPlannedToDoItemSettings(this GetPlannedToDoItemSettingsReply value);
    ...
    public static OptionStruct<ActiveToDoItem> ToOptionActiveToDoItem(this ActiveToDoItemGrpc? value)
    {
        if (value is null)
        {
            return new(null);
