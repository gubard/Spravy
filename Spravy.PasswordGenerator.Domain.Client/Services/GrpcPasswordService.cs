    ...
    IGrpcServiceCreatorAuth<GrpcPasswordService, PasswordServiceClient>
{
    ...
    public Cvtar UpdatePasswordItemNameAsync(Guid id, string name, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemNameAsync(
                            new()
                            {
                                Id = id.ToByteString(),
                                Name = name,
    ...
    public Cvtar UpdatePasswordItemKeyAsync(Guid id, string key, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemKeyAsync(
                            new()
                            {
                                Id = id.ToByteString(),
                                Key = key,
    ...
    public Cvtar UpdatePasswordItemLengthAsync(Guid id, ushort length, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemLengthAsync(
                            new()
                            {
                                Id = id.ToByteString(),
                                Length = length,
    ...
    public Cvtar UpdatePasswordItemRegexAsync(Guid id, string regex, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemRegexAsync(
                            new()
                            {
                                Id = id.ToByteString(),
                                Regex = regex,
    ...
    public Cvtar UpdatePasswordItemIsAvailableNumberAsync(Guid id, bool isAvailableNumber, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemIsAvailableNumberAsync(
                            new()
                            {
                                Id = id.ToByteString(),
    ...
    public Cvtar UpdatePasswordItemIsAvailableLowerLatinAsync(Guid id, bool isAvailableLowerLatin, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemIsAvailableLowerLatinAsync(
                            new()
                            {
                                Id = id.ToByteString(),
    ...
    )
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemIsAvailableSpecialSymbolsAsync(
                            new()
                            {
                                Id = id.ToByteString(),
    ...
    )
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemCustomAvailableCharactersAsync(
                            new()
                            {
                                Id = id.ToByteString(),
    ...
    public Cvtar UpdatePasswordItemIsAvailableUpperLatinAsync(Guid id, bool isAvailableUpperLatin, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemIsAvailableUpperLatinAsync(
                            new()
                            {
                                Id = id.ToByteString(),
    ...
    public Cvtar UpdatePasswordItemLoginAsync(Guid id, string login, CancellationToken ct)
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client.UpdatePasswordItemLoginAsync(
                            new()
                            {
                                Id = id.ToByteString(),
                                Login = login,
