...
public class NotFoundUserSecretError : Error
{
    ...
    protected NotFoundUserSecretError() : base(MainId)
    {
    }

    public NotFoundUserSecretError(Guid userId) : base(MainId)
    {
        UserId = userId;
    }
    ...
    public override string Message => $"Not found secret for user \"{UserId}\".";
}