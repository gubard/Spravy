...
public class SpravyPasswordDesignTimeDbContextFactory : IDesignTimeDbContextFactory<PasswordSpravyDbContext>
{
    public PasswordSpravyDbContext CreateDbContext(string[] args)
    {
