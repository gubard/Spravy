...
public class SpravyDbToDoDbContext : SpravyDbContext, IDbContextCreator<SpravyDbToDoDbContext>
{
    ...
    protected SpravyDbToDoDbContext(IDbContextSetup setup)
        : base(setup) { }

    public SpravyDbToDoDbContext(DbContextOptions options, IDbContextSetup setup)
        : base(options, setup) { }

    public static SpravyDbToDoDbContext CreateDbContext(
