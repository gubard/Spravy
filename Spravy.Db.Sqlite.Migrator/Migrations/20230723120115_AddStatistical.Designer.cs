...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spravy.Db.Models.ToDoItemGroupEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Spravy.Db.Models.ToDoItemStatisticalEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Spravy.Db.Models.ToDoItemValueEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Spravy.Db.Models.ToDoItemEntity", b =>
                {
                    b.HasOne("Spravy.Db.Models.ToDoItemGroupEntity", "Group")
                        .WithOne("Item")
                        .HasForeignKey("Spravy.Db.Models.ToDoItemEntity", "GroupId")
                    ...
                    b.HasOne("Spravy.Db.Models.ToDoItemStatisticalEntity", "Statistical")
                        .WithOne("Item")
                        .HasForeignKey("Spravy.Db.Models.ToDoItemEntity", "StatisticalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Spravy.Db.Models.ToDoItemValueEntity", "Value")
                        .WithOne("Item")
                        .HasForeignKey("Spravy.Db.Models.ToDoItemEntity", "ValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
