...
public class TypeInvalidCastException : InvalidCastException
{
    ...
    public TypeInvalidCastException(Type currentType, params Type[] expectedTypes) : base(
        CreateMessage(expectedTypes, currentType)
    )
    {
        CurrentType = currentType;
    ...
    public TypeInvalidCastException(Type currentType, IEnumerable<Type> expectedTypes) : this(
        currentType,
