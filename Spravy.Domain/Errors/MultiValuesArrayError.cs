...
public class MultiValuesArrayError : Error
{
    ...
    protected MultiValuesArrayError() : base(MainId)
    {
        Name = string.Empty;
    }

    public MultiValuesArrayError(string name, ulong arrayLength) : base(MainId)
    {
        Name = name;
    ...
    public override string Message => $"Array {Name} has {ArrayLength} values";
}