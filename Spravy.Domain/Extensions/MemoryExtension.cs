...
public static class MemoryExtension
{
    ...
    {
        var result = new Span<char>(new char[memory.Select(x => x.Length).Sum()
    ...
    public static Span<TSource> SelectMany<TSource>(this ReadOnlyMemory<ReadOnlyMemory<TSource>> memory)
    {
