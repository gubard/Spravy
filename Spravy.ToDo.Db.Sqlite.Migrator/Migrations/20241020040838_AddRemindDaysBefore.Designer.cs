...
namespace Spravy.ToDo.Db.Sqlite.Migrator.Migrations
{
    ...
    [Migration("20241020040838_AddRemindDaysBefore")]
    partial class AddRemindDaysBefore
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Spravy.ToDo.Db.Models.ToDoItemEntity", b =>
                {
                    ...
                    b.Property<uint>("RemindDaysBefore")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Spravy.ToDo.Db.Models.ToDoItemEntity", b =>
                {
                    ...
                    b.HasOne("Spravy.ToDo.Db.Models.ToDoItemEntity", "Reference")
                        .WithMany()
