    ...
    IGrpcServiceCreatorAuth<GrpcToDoService, ToDoService.ToDoServiceClient>
{
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.SearchToDoItemIdsAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.Ids.ToGuid().ToResult(), ct), ct),
            ct);
    }
    ...
    public ConfiguredValueTaskAwaitable<Result<ToDoItem>> GetToDoItemAsync(Guid id, CancellationToken ct)
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetToDoItemAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToToDoItem().ToResult(), ct), ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetChildrenToDoItemShortsAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.Items.ToToDoShortItem().ToResult(), ct),
                ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client
                       .GetRootToDoItemIdsAsync(new(), metadata, DateTime.UtcNow.Add(Timeout), ct)
                       .ToValueTaskResultValueOnly()
                       .ConfigureAwait(false)
                       .IfSuccessAsync(reply => reply.Ids.ToGuid().ToResult(), ct), ct),
            ct);
    ...
    )
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client
                       .GetFavoriteToDoItemIdsAsync(new(), metadata, DateTime.UtcNow.Add(Timeout), ct)
                       .ToValueTaskResultValueOnly()
                       .ConfigureAwait(false)
                       .IfSuccessAsync(reply => reply.Ids.ToGuid().ToResult(), ct), ct),
            ct);
            ...
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client
                       ...
                       .ToValueTaskResultValueOnly()
                       .ConfigureAwait(false)
                       .IfSuccessAsync(id => id.Id.ToGuid().ToResult(), ct), ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(
            client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(
                    metadata => client
                       .GetTodayToDoItemsAsync(new(), metadata, DateTime.UtcNow.Add(Timeout), ct)
                       .ToValueTaskResultValueOnly()
                       .ConfigureAwait(false)
                       .IfSuccessAsync(reply => reply.Ids.ToGuid().ToResult(), ct), ct),
            ct);
           ...
           .IfSuccessAsync(metadata =>
            {
                ...
                return client
                   .GetToDoSelectorItemsAsync(request, metadata, DateTime.UtcNow.Add(Timeout), ct)
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetSiblingsAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(items => items.Items.ToToDoShortItem().ToResult(), ct),
                ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetPlannedToDoItemSettingsAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToPlannedToDoItemSettings().ToResult(), ct),
                ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetValueToDoItemSettingsAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToValueToDoItemSettings().ToResult(), ct),
                ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
           .IfSuccessAsync(metadata => client.GetPeriodicityToDoItemSettingsAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToPeriodicityToDoItemSettings().ToResult(), ct),
                ct), ct);
    }
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetWeeklyPeriodicityAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToWeeklyPeriodicity().ToResult(), ct),
                ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetMonthlyPeriodicityAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToMonthlyPeriodicity().ToResult(), ct),
                ct),
            ct);
    }
    ...
    )
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
               .IfSuccessAsync(metadata => client.GetAnnuallyPeriodicityAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToAnnuallyPeriodicity().ToResult(), ct),
                ct),
            ct);
    }
        ...
        GetPeriodicityOffsetToDoItemSettingsAsync(Guid id, CancellationToken ct)
    {
        return CallClientAsync(client => metadataFactory.CreateAsync(ct)
           .IfSuccessAsync(metadata => client.GetPeriodicityOffsetToDoItemSettingsAsync(new()
                   ...
                   .ToValueTaskResultValueOnly()
                   .ConfigureAwait(false)
                   .IfSuccessAsync(reply => reply.ToPeriodicityOffsetToDoItemSettings().ToResult(), ct),
                ct), ct);
    }
    ...
    )
    {
        ...
        using var response =
            client.GetToDoItems(request, metadata.Value, DateTime.UtcNow.Add(Timeout), ct);
