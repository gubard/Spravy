...
public class SpravyCommandService
{
    ...
    )
    {
        ...
        CopyLogin = SpravyCommand.Create<PasswordItemEntityNotify>(
            (passwordItem, ct) =>
                clipboardService
                    .SetTextAsync(passwordItem.Login, ct)
                    .IfSuccessAsync(
                        () =>
                            spravyNotificationManager.ShowAsync(
                                new TextLocalization(
                                    "PasswordGeneratorView.Notification.CopyLogin",
                                    passwordItem
                                ),
                                ct
                            ),
                    ...
                    .IfSuccessAsync(
                        editId =>
                            dialogViewer.ShowConfirmDialogAsync(
                                viewFactory,
                                DialogViewLayer.Content,
                                viewFactory.CreateDeleteToDoItemViewModel(
                                    editId.Item,
                                    editId.Items
                                ),
                                vm =>
                                    dialogViewer
                                        ...
                                        .IfSuccessAsync(
                                            type =>
                                            {
                                                ...
                                                if (
                                                    editId.Item.TryGetValue(out var item)
                                                    && item.Parent is not null
                                                )
                                                {
                                                    return navigator.NavigateToAsync(
                                                        viewFactory.CreateToDoItemViewModel(
                                                            item.Parent
                                                        ),
                                                        ct
                                                    );
                    ...
                    .IfSuccessAsync(
                        editId =>
                            dialogViewer.ShowConfirmDialogAsync(
                                viewFactory,
                                DialogViewLayer.Content,
                                viewFactory.CreateToDoItemToStringSettingsViewModel(
                                    editId.Item,
                                    editId.Items
                                ),
                                vm =>
                    ...
                    .IfSuccessAsync(
                        editId =>
                            dialogViewer.ShowConfirmDialogAsync(
                                viewFactory,
                                DialogViewLayer.Content,
                                viewFactory.CreateRandomizeChildrenOrderViewModel(
                                    editId.Item,
                                    editId.Items
                                ),
                                vm =>
                    ...
                    .IfSuccessAsync(
                        editId =>
                            dialogViewer.ShowConfirmDialogAsync(
                                viewFactory,
                                DialogViewLayer.Input,
                                viewFactory.CreateCreateReferenceViewModel(
                                    editId.Item,
                                    editId.Items
                                ),
                                vm =>
                    ...
                    .IfSuccessAsync(
                        editId =>
                            dialogViewer.ShowConfirmDialogAsync(
                                viewFactory,
                                DialogViewLayer.Content,
                                viewFactory.CreateEditDescriptionViewModel(
                                    editId.Item,
                                    editId.Items
                                ),
                                vm =>
                ...
                dialogViewer.ShowConfirmDialogAsync(
                    ...
                    _ =>
                        dialogViewer
                            ...
                            .IfSuccessAsync(
                                () =>
                                    passwordService.UpdatePasswordItemLoginAsync(
                                        item.Id,
                                        item.Login,
                                        ct
                                    ),
                    ...
                    .IfSuccessAsync(
                        editId =>
                            dialogViewer.ShowConfirmDialogAsync(
                                viewFactory,
                                DialogViewLayer.Content,
                                viewFactory.CreateToDoItemCreateTimerViewModel(
                                    editId.Item,
                                    editId.Items
                                ),
                                vm =>
                                    dialogViewer
                                        .CloseDialogAsync(DialogViewLayer.Content, ct)
                                        .IfSuccessAsync(
                                            () => vm.CreateAddTimerParametersAsync(ct),
                                            ct
                                        )
                                        .IfSuccessAsync(
                                            parameters =>
                                                scheduleService.AddTimerAsync(parameters, ct),
                                            ct
                                        )
                                        .IfSuccessAsync(
                                            () => uiApplicationService.RefreshCurrentViewAsync(ct),
