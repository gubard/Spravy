...
public class RpcExceptionHandler : IRpcExceptionHandler
{
    ...
    private async ValueTask<ReadOnlyMemory<Error>> GetErrorsAsync(Guid id, Metadata.Entry trailer, CancellationToken ct)
    {
        ...
        {
            var error = await serializer.DeserializeAsync<UserIdentifierTypeOutOfRangeError>(stream, ct);
        ...
        {
            var error = await serializer.DeserializeAsync<NonItemSelectedError>(stream, ct);
        ...
        {
            var error = await serializer.DeserializeAsync<ToDoItemIsCanOutOfRangeError>(stream, ct);
        ...
        {
            var error = await serializer.DeserializeAsync<ToDoItemAlreadyCompleteError>(stream, ct);
        ...
        {
            var error = await serializer.DeserializeAsync<ToDoItemTypeOutOfRangeError>(stream, ct);
        ...
        {
            var error = await serializer.DeserializeAsync<NotFoundError>(stream, ct);
        ...
        {
            var error = await serializer.DeserializeAsync<NotFoundUserSecretError>(stream, ct);
