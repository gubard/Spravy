...
public class CreateUserCommands
{
    ...
    )
    {
        ...
        EnterCommand = SpravyCommand.Create<CreateUserView>(
            EnterAsync,
            errorHandler,
            taskProgressService
        );

        CreateUserCommand = SpravyCommand.Create<CreateUserViewModel>(
            CreateUserAsync,
            errorHandler,
            taskProgressService
        );
    ...
    private ConfiguredValueTaskAwaitable<Result> EnterAsync(
        CreateUserView view,
                        ...
                        .IfSuccess(emailTextBox =>
                            view.FindControl<TextBox>(CreateUserView.LoginTextBoxName)
                                ...
                                .IfSuccess(loginTextBox =>
                                    view.FindControl<TextBox>(CreateUserView.PasswordTextBoxName)
