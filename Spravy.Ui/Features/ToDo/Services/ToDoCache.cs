...
public class ToDoCache : IToDoCache
{
    ...
    private readonly SemaphoreSlim semaphoreToDoItem = new(1, 1);
    private readonly SemaphoreSlim semaphoreActive = new(1, 1);
